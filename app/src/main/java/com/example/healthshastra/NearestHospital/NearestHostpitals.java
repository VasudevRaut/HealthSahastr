...
import com.example.healthshastra.BookApointment;
import com.example.healthshastra.BookApointmentAdapter;
...
public class NearestHostpitals extends AppCompatActivity implements OnMapReadyCallback {
...
//    Map<String,EVStation> mpevstation = new HashMap<>();
    ...
    RecyclerView hospitallistrecycler;

    List<HospitalListModel> data_list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nearest_hostpitals);
        ...
        if(mapFragment!=null)
        {
            mapFragment.getMapAsync((OnMapReadyCallback) NearestHostpitals.this);
        }
...
//        init();
    ...
    private void fetchhospitalList() {
        ...
        hospitallistrecycler = findViewById(R.id.hospitallistrecycler);
        layoutManager = new LinearLayoutManager(this);

        layoutManager.setOrientation(RecyclerView.VERTICAL);
        hospitallistrecycler.setLayoutManager(layoutManager);
        ...
        data_list.add(new HospitalListModel());
        data_list.add(new HospitalListModel());
        data_list.add(new HospitalListModel());
        data_list.add(new HospitalListModel());
        data_list.add(new HospitalListModel());
        ...
        hospitalListAdapter = new HospitalListAdapter(data_list, NearestHostpitals.this);
        hospitallistrecycler.setAdapter(hospitalListAdapter);
...
//                showBottomSheetDialog(marker.getTag()+"");
    ...
    public void getCurrentLocation1()
    {
        ...
        if (ContextCompat.checkSelfPermission(getApplicationContext(),
            ...
            ActivityCompat.requestPermissions(NearestHostpitals.this,
...
//        Toast.makeText(this, "getcurrentLocation", Toast.LENGTH_SHORT).show();
        ...
        LocationServices.getFusedLocationProviderClient(NearestHostpitals.this)
...
//                        Toast.makeText(MainActivity.this, "when set locatin", Toast.LENGTH_SHORT).show();
                        if (locationResult != null && locationResult.getLocations().size() > 0) {
                            ...
                            Toast.makeText(NearestHostpitals.this, "lati : "+lati, Toast.LENGTH_SHORT).show();
