...
public class DoctorListAdapter extends RecyclerView.Adapter<DoctorListAdapter.LeadData>{

    List<DoctorListModel> dataholder2;
...
//    private FirebaseFirestore firebaseFirestore;
    ...
    public DoctorListAdapter(List<DoctorListModel> dataholder2, Context context) {
...
//    }
    ...
    public void setFilteredList(List<DoctorListModel> filteredList) {
...
//        init();
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.doctorlistcard,parent,false);
