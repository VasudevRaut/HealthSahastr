...
public class BookslotAdapter extends RecyclerView.Adapter<BookslotAdapter.LeadData>{

    List<BookApointmentModel> dataholder2;
...
//    private FirebaseFirestore firebaseFirestore;
    ...
    public BookslotAdapter(List<BookApointmentModel> dataholder2, Context context) {
...
//    }
    ...
    public void setFilteredList(List<BookApointmentModel> filteredList) {
...
//        init();
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.bookslotcard,parent,false);
