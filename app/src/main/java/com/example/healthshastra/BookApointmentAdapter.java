...
public class BookApointmentAdapter extends RecyclerView.Adapter<BookApointmentAdapter.LeadData>{
...
//    private FirebaseFirestore firebaseFirestore;
    ...
    public BookApointmentAdapter(List<BookApointmentModel> dataholder2, Context context) {
